...
#region Default Instance
		...
		public void btnRegister_Click(System.Object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Te rugam sa completezi toate randurile");
			...
			else
			{
				...
				{
					MessageBox.Show("Acest cont deja exista");
				}
				else
				{
					string dbcommand = "INSERT into tblinfo (account_no, Firstname, Lastname, Address, Contact_no, Gender, Birthday, pin_code , type, balance)" + " VALUES (\'" + (txtAcctNo.Text + "\',\'") + txtfname.Text + "\',\'" + txtlname.Text + "\',\'" + txtaddr.Text + "\',\'" + txtcontact.Text + "\',\'" + cbGender.Text + "\',\'" + (cbmonth.Text + cbday.Text + cbyear.Text) + "\',\'" + txtPincode.Text + "\',\'" + "Active" + "\',\'" + "100" + "\')";
					System.Data.OleDb.OleDbDataAdapter adapt = new System.Data.OleDb.OleDbDataAdapter(dbcommand, conn);
					DataSet dset = new DataSet();
					adapt.Fill(dset);
					MessageBox.Show("Ai fost inregistrat cu succes!");
					this.Hide();
