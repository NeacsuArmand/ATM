...
#region Default Instance
		...
		public void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show("Doresti sa continui aceasta tranzactie??", "Continuare", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
			{
				Mainmenu.Default.Show();
			}
			else
			{
				MessageBox.Show("Multumim! Te mai asteptam!");
