			...
			try
			{
				...
				else
				{
					...
					if (Log_in.Rows.Count > 0)
					{
						...
						if (Type == "admin")
						{
							MessageBox.Show("Bine ai venit " + Fullname + ". Ai fost logat ca administrator.");
						...
						{
							MessageBox.Show("Acest cont este blocat.");
							MessageBox.Show("Contacteaza un administrator pentru ajutor.");
							
						}
						else
						{
							MessageBox.Show("Bine ai venit,  " + Fullname);
					...
					{
						MessageBox.Show("Nu ai un cont pe aceasta platforma!!!");
						MessageBox.Show("Iti poti face un cont daca esti nou aici!");
